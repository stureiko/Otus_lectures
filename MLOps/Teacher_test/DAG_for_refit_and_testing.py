...
YC_SOURCE_BUCKET = 'bucket-name'     # YC S3 bucket for pyspark source files
YC_DP_LOGS_BUCKET = 'bucket-name/airflow_logs/'      # YC S3 bucket for Data Proc cluster logs
...
with DAG(
    ...
    model_reffit = DataprocCreatePysparkJobOperator(
        ...
        main_python_file_uri=f's3a://bucket-name/model_reffit3.py',
        connection_id = ycSA_connection.conn_id,
        dag=ingest_dag,
